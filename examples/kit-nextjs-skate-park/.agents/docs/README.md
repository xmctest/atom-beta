...
| [AGENTS-key-concepts.md](AGENTS-key-concepts.md) | Middleware, SitecoreClient, catch-all, locale, component maps |
| [AGENTS-router-specifics.md](AGENTS-router-specifics.md) | Routing, next-intl, proxy, data fetching, API routes, layout |
